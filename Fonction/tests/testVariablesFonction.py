...
from Fonction.fonction import _Variables, VariablesDependantes, VariablesIndependantes, Fonction
from Fonction.regression_interpolation import LiaisonMixte, RegressionPolynomiale, \
    RegressionGenerale
import numpy as np
